                            ...
                            @foreach ($salles as $salle)
                                <div
                                    ...
                                    <div class="flex items-center justify-end gap-6">
                                        <button data-modal-target="crud-modal-{{ $salle->id }}"
                                            data-modal-toggle="crud-modal-{{ $salle->id }}" type="button">
                                ...
                                <div id="crud-modal-{{ $salle->id }}" tabindex="-1" aria-hidden="true"
                                    class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                    <div class="relative p-4 w-full max-w-md max-h-full">
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            <div
                                                ...
                                                <button type="button"
                                                    ...
                                                    data-modal-toggle="crud-modal-{{ $salle->id }}">
                                            ...
                                            <div class="p-4 md:p-5">
                                                <form class="space-y-4"
                                                    action="{{ route('updateSalle', $salle->id) }}" method="post"
                                                    enctype="multipart/form-data">
                                                    @csrf
                                                    @method('PUT')
                                                    ...
                                                    <div class="col-span-2">
                                                        <input type="hidden" name="salleID" id="editSalleId"
                                                            value="{{ $salle->id }}">
                                                        <label for="" class="block mb-2 text-sm font-medium text-gray-900 text-black">Nom
                                                            de la salle</label>
                                                    ...
                                                    <div class="col-span-2">
                                                        ...
                                                        <label for=""
                                                            ...
                                                            de la salle</label>
                                                        <img src="{{ asset('img/' . $salle->profile_picture) }}" alt="Current Image">

                                                        <input type="file" name="profile_picture" id="editPicture"
                                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 bg-gray-100 border-gray-500 placeholder-gray-400 text-black focus:ring-primary-500 focus:border-primary-500"
