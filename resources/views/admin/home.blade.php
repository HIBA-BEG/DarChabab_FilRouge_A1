    ...
    <div class="relative">
        ...
        <section class="main-content">
            ...
            <section class="text-gray-600 body-font bg-gray-50 h-screen flex justify-center items-center">
                <div class="container px-5 py-24 mx-auto md:mt-64">
                        ...
                        <div class="p-4 sm:w-1/2 lg:w-1/3 w-full hover:scale-105 duration-500">
                            <div
                                ...
                                <div>
                                    ...
                                    <p class="text-sm font-semibold text-gray-400">Last Transaction</p>
                                    <button
                                        class="text-sm mt-6 px-4 py-2 bg-red-400  text-white rounded-lg  tracking-wider hover:bg-red-500 outline-none">Add
                                        to cart</button>
                                </div>
                                <div
                        ...
                        <div class="p-4 sm:w-1/2 lg:w-1/3 w-full hover:scale-105 duration-500">
                            <div
                                ...
                                <div>
                                    ...
                                    <p class="text-sm font-semibold text-gray-400">Last Transaction</p>
                                    <button
                                        class="text-sm mt-6 px-4 py-2 bg-cyan-400  text-white rounded-lg  tracking-wider hover:bg-cyan-500 outline-none">Add
                                        to cart</button>
                                </div>
                                <div
