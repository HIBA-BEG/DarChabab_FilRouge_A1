                ...
                <form method="POST" action="{{ route('register') }}" class="sm:w-2/3 w-full px-4 lg:px-0 mx-auto"
                    ...
                    <div class="pb-2 pt-4">
                        <input type="email" name="email" id="email" placeholder="Email"
                            class="block w-full p-4 text-lg rounded-sm bg-black @error('email') border-red-500 @enderror">
                        @error('email')
                            <p class="text-red-500 text-sm mt-2">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="pb-2 pt-4">
                        <input type="tel" name="phoneNumber" id="phoneNumber" placeholder="phoneNumber"
                            class="block w-full p-4 text-lg rounded-sm bg-black @error('phoneNumber') border-red-500 @enderror">
                        @error('phoneNumber')
                            <p class="text-red-500 text-sm mt-2">{{ $message }}</p>
                        @enderror
                    </div>
