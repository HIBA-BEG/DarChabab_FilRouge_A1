 <nav class=" lg:px-16 px-9 shadow-md flex flex-wrap items-center lg:py-2 py-2">
     <div class="flex-1 flex justify-center gap-6">
         ...
         <a href="https://www.facebook.com/maisondesjeuneshayoumali" class="h-6 w-6">
             <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                 <path fill="#4D1F24"
                     d="M512 256C512 114.6 397.4 0 256 0S0 114.6 0 256C0 376 82.7 476.8 194.2 504.5V334.2H141.4V256h52.8V222.3c0-87.1 39.4-127.5 125-127.5c16.2 0 44.2 3.2 55.7 6.4V172c-6-.6-16.5-1-29.6-1c-42 0-58.2 15.9-58.2 57.2V256h83.6l-14.4 78.2H287V510.1C413.8 494.8 512 386.9 512 256h0z" />
             </svg>
         </a>
         <a href="" id="copyPhoneNumber" class="h-6 w-6">
             <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                 <path fill="#4D1F24"
             ...
             <ul class="text-xl font-semibold text-black text-center items-center gap-x-5 pt-4 md:gap-x-4 lg:text-lg lg:flex  lg:pt-0 ">
                 ...
                 @auth
                     @if (auth()->user()->role == 'Admin')
                         <li class="py-2 lg:py-0 ">
                             <a class="hover:pb-4 hover:border-b-4 hover:border-[#4D1F24]" href="{{ route('admin.home') }}">
                                 Mon Dashboard
                             </a>
                         </li>
                     @else
                         <li class="py-2 lg:py-0 ">
                             <a class="hover:pb-4 hover:border-b-4 hover:border-[#4D1F24]"
 ...
 <script>
    ...
    var phoneNumber = '212 658 144 394'; 
    var copyPhoneNumberBtn = document.getElementById('copyPhoneNumber');

    copyPhoneNumberBtn.addEventListener('click', function(event) {
        event.preventDefault();

        // Create a dummy textarea element to hold the phone number
        var dummyTextArea = document.createElement('textarea');
        dummyTextArea.value = phoneNumber;

        // Append the textarea to the body
        document.body.appendChild(dummyTextArea);

        // Select the phone number inside the textarea
